...
| Document | Objet |
|---|---|
| `docs/plan-adressage.md` | Segments, adressage, nomenclature, conventions |
| `docs/matrice-de-flux.md` | Flux autorisés entre segments et justifications |
| `docs/configuration-fw01.md` | Pare-feu : interfaces, DHCP, règles de filtrage |
| `docs/configuration-dc01.md` | Contrôleur de domaine : forêt, annuaire, groupes, GPO |
| `docs/configuration-pc01.md` | Poste client : jonction, stratégies, tests d'isolement |
| `docs/configuration-srv01.md` | Serveur Linux : durcissement, pare-feu local, sauvegardes |
| `docs/authentification-centralisee.md` | RADIUS, PKI interne, autorisation par groupe |
| `docs/durcissement-postes.md` | Administration locale et gestion des secrets machines |
| `docs/supervision-detection.md` | Plan de détection, collecte, règles et méthode d'analyse |
| `docs/automatisation.md` | Scripts en service, choix de conception et limites |

## Journal de bord

| Session | Objet |
|---|---|
| 01 | Plan d'adressage et conventions |
| 02 | Mise en service du pare-feu |
| 03 | Filtrage inter-VLAN |
| 04 | Mise en service de l'annuaire |
| 05 | Poste client et diagnostic de stratégie |
| 06 | Serveur Linux et automatisation |
| 07 | Authentification centralisée |
| 08 | Durcissement des postes |
| 09 | Supervision et détection |
| 10 | Vérification de la chaîne de collecte et hiérarchisation |
| 11 | Référence de temps, audit des postes et sources de supervision |
